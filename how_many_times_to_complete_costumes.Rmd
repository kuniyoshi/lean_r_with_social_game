...
31人分のコスチュームを集めたいです。小難しい数式を見るのは後回しにして、簡単にシミュレーションしてみましょう。
...
95パーセンタイルが`r sgs.completion_count_summary$NinetyfivePercentile`なのでよっぽど運が悪くなければ、`r sgs.completion_count_summary$NinetyfivePercentile`回でコンプリートできます。
